...
| **Performance Profile** | Target FPS, frame resolution, video fit, deinterlacing, sampling breadth/mode, smoothing, audio low/mid/high band centers, Audio Band Spread, Audio Beat Pulse and Release, Audio Visualizer Palette, Audio Spatial Routing, and Audio Source Channels can be overridden per user while blank fields inherit global settings. |
